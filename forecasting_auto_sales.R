...
ggsave("images/narrowed model.png", width = 8, height = 6)
...
ggsave("images/variable error plot.png", width = 8, height = 6)
...
ggcoef(
  ...
  errorbar_height = .25,
  exclude_intercept = TRUE)
ggsave("images/seasonal model.png", width = 8, height = 6)
...
ggsave("images/sesonality lm.png", width = 8, height = 6)
...
ggsave("images/combined model.png", width = 8, height = 6)
...
ggsave("images/rgdp model.png", width = 8, height = 6)
summary(custom_ES3)
